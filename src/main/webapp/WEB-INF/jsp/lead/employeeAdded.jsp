...
<body>
	<div id="container">
       ...
       <nav id="my-menu">
        ...
        <div class="page-title">EMPLOYEE ADDED</div>
        <div class="main-content">
        	<div class="sub-content">
            	<div class="sub-title">The employee has been added to the database!</div>
            	<a class="submit-button" href="/hellospringjersey/do/employee/addEmployee">Add Another Employee</a>
