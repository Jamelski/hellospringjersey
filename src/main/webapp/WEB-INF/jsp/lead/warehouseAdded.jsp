...
<body>
	<div id="container">
       ...
       <nav id="my-menu">
        ...
        <div class="page-title">WAREHOUSE ADDED</div>
        <div class="main-content">
        	<div class="sub-content">
            	<div class="sub-title">The warehouse has been added to the database!</div>
            	<a class="submit-button" href="/hellospringjersey/do/logisticslead/request">Add Another Warehouse</a>
